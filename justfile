...
pages-build DIST='../dist/pages' PUBLIC_URL='/detonito':
	env -u NO_COLOR trunk build --release --minify --dist "{{DIST}}" --public-url "{{PUBLIC_URL}}" --no-default-features --features web-static
